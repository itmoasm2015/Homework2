...
int main() {
    ...
    int elem = matrixGet(matrix, 1, 1);
    printf("!elem = %d!\n", elem);
    Matrix matrix2 = matrixScale(matrix, 5);
    int elem2 = matrixGet(matrix2, 1, 1);
    printf("!elem2 = %d!\n", elem2);
    Matrix matrixSum = matrixAdd(matrix, matrix2);
    int elemSum = matrixGet(matrixSum, 1, 1);
    printf("!elemSum = %d!\n", elemSum);
    Matrix matrixMult = matrixMul(matrix, matrix2);
    int elemMul = matrixGet(matrixMult, 1, 1);
    printf("!elemMul = %d!\n", elemMul);
    int elem3 = matrixGet(matrix, 2, 1);
    printf("!elem = %d!\n", elem3);
    matrixDelete(matrix);
